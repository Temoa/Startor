...
public class HomeRecyclerAdapter extends RecyclerView.Adapter<RecyclerHolder> implements View.OnClickListener {
    ...
    public HomeRecyclerAdapter(Context context, RecyclerView recyclerView, List<VideoList> data) {
        mContext = context;
    ...
    public void onBindViewHolder(final RecyclerHolder holder, int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                sectionTitle1.setText(R.string.item_hot);
            ...
            case 6:
                ...
                sectionTitle2.setText(R.string.item_new_video);
