...
public class VideoRecyclerAdapter extends RecyclerView.Adapter<RecyclerHolder>
    ...
    public VideoRecyclerAdapter(Context context, VideoInfo headerData, List<video> listData) {
        mContext = context;
    ...
    public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEADER)
            itemView = mLayoutInflater.inflate(R.layout.recycler_header_video, parent, false);
        else
            itemView = mLayoutInflater.inflate(R.layout.video_item, parent, false);
