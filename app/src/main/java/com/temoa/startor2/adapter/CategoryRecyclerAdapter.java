...
public class CategoryRecyclerAdapter extends RecyclerView.Adapter<RecyclerHolder> {
    ...
    public CategoryRecyclerAdapter(Context context, RecyclerView recyclerView, List<VideoList> data) {
        mContext = context;
    ...
    public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (isLoadMore && viewType == TYPE_FOOTER)
            itemView = mLayoutInflater.inflate(R.layout.recycler_footer_category, parent, false);
        else
            itemView = mLayoutInflater.inflate(R.layout.common_item, parent, false);
    ...
    private void bindFooterViewHolder(RecyclerHolder holder) {
        switch (loadModeStatus) {
            case STATUS_LOADING:
                ...
                holder.setText(R.id.footer_title, "正在加载更多...");
                break;
            case STATUS_EMPTY:
                isLoading = false;
                holder.getItemView().setVisibility(View.VISIBLE);
                ...
                holder.setVisibility(R.id.footer_title, View.VISIBLE);
                holder.setText(R.id.footer_title, "- END -");
                break;
            case STATUS_ERROR:
                isLoading = false;
                holder.getItemView().setVisibility(View.VISIBLE);
                holder.setVisibility(R.id.footer_progress, View.GONE);
                holder.setVisibility(R.id.footer_title, View.VISIBLE);
                holder.setText(R.id.footer_title, "加载出错,请重试");
                break;
            case STATUS_PREPARE:
                isLoading = false;
